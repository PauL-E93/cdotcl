...
function getAttendanceBranchAdminBranchId() {
    global $role;
...
class AttendanceModule {
    ...
    private function sectionBelongsToBranch($conn, $sectionId, $branchId) {
        if (!$branchId) {
            return true;
        }
    ...
    private function getSectionContext($conn, $sectionId) {
    ...
    public function getSectionAttendanceDashboard() {
        ...
        $branchId = getAttendanceBranchAdminBranchId();
        ...
        if (!$this->sectionBelongsToBranch($conn, $sectionId, $branchId)) {
            denyAttendanceAccess();
            return;
        }

        $section = $this->getSectionContext($conn, $sectionId);
        if (!$section) {
